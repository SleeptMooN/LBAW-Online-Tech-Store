            ...
            <div class="modal-body">
                <form action="{{ route('product.add') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea name="description" id="description" rows="5" cols="50" class="form-control @error('description') is-invalid @enderror" required>{{ old('description') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="category" name="category">
                            ...
                            <option value = 4>Acessories</option>
                        </select>
                    </div>
                    <div class="form-group">
